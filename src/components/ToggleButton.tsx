    ...
    return (
      <div className={classNames(styles.wrapper, className)}>
        <input
          ...
          type="checkbox"
          id={id}
          className={classNames(styles.toggle_input, {
            [styles["toggle_input--sm"]]: size === "sm",
          })}
          onChange={(event) => {
        ...
        />
        <label
          className={styles.toggle_input__label}
          htmlFor={id}
          aria-label={
        ...
        >
          {labelText}
          <span className={styles.toggle_input__switch}>
            {size === "sm" && (
              <svg
                className={styles.toggle_input__check}
                width="6px"
                height="5px"
                viewBox="0 0 6 5"
              >
            ...
            <span className={styles.toggle_input__text_off} aria-hidden="true">
              {offLabel}
            </span>
            <span className={styles.toggle_input__text_on} aria-hidden="true">
              {onLabel}
            </span>
          </span>
        </label>
