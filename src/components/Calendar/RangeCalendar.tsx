...
function RangeCalendar({
    ...
    return (
        <div
            tabIndex={0}
            ref={containerRef}
            className={classNames("date_picker__container", className, {
                "date_picker__input--disabled": disabled,
            })}
            onFocus={showModal}
            onBlur={dateModalBlurHandler}
            {...other}
        >
            <div className={"date_picker__range_actions"}>
                <input
                    ref={inputFromRef}
                    value={fromInputVal}
                    onChange={changeFromInputVal}
                    className={"date_picker__range_actions--input"}
                    onFocus={showModal}
                    onBlur={onInputFromBlur}
                    disabled={disabled}
                />
                <span className={"date_picker__range_actions--icon"}>
                    <Minus />
                </span>
                <input
                    ref={inputToRef}
            ...
            <button onClick={clearValue} className={"date_picker__clear_btn"}>
                <XIcon />
            </button>
            <Calendar
                ref={calendarRef}
