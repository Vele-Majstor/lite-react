...
declare function ComboMultiSelect<T>({ loading, disabled, showClear, placeholder, options, filterBy, onChange, onChangeFilterValue, value, filterValue, className, itemTemplate, ...other }: Props<T>): JSX.Element;
